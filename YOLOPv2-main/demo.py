...
def detect():
    ...
    cv_source = cv2.imread(source)
    dataset = LoadImages(source, cv_source, img_size=imgsz, stride=stride)
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        # print values of da_seg_mask and ll_seg_mask
        # print(np.unique(da_seg_mask))
        # print(np.unique(ll_seg_mask))
        
        # save masks
        save_masks(da_seg_mask.copy(), ll_seg_mask.copy(), save_dir)       
